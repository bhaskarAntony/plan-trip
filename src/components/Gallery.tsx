...
const Gallery: React.FC = () => {
  ...
  const images = [
    ...
    {
      url: "https://images.pexels.com/photos/8199562/pexels-photo-8199562.jpeg",
      caption: "Sports day memories"
    }
  ];

  return (
    <section id="gallery" ref={ref} className="section py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          A glimpse of our cherished moments from school days
        </motion.p>
        ...
        >
          <h3 className="text-xl font-serif font-bold text-primary-700 mb-4">Share Your Memories</h3>
